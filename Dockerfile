...
COPY --from=gobuild-vespamgr /go/src/vespamgr/config/config-file.json /etc/ves-agent/config-file.json
COPY --from=gobuild-vespamgr /go/src/vespamgr/config/uta_rtg.rt /etc/ves-agent/uta_rtg.rt
